...
<?php //$posts = get_posts("category=4&numberposts=1&orderby=ID");?>
	...
	<?php get_posts_with_tag("数学");?>
	<?php get_posts_with_tag("物理");?>
	<?php get_posts_with_tag("计算机");?>
	<?php get_posts_with_tag("游戏");?>
	<?php get_posts_with_tag("IQ");?>
	<?php get_posts_with_tag("科学大事记");?>
